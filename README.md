...
> ⚠️ **หมายเหตุความซื่อสัตย์:** ระบบที่ทดสอบเป็นเว็บไซต์ตัวอย่างสมมติขึ้นเพื่อการเรียนรู้ (ไม่ใช่เว็บไซต์จริง) — ผลการทดสอบ PASS/FAIL และ Bug ทั้ง 3 รายการเป็น **รอบจำลองที่สมจริง (simulated run)** เพื่อสาธิตกระบวนการทดสอบครบวงจร ส่วน Requirement, Test Scenario และ Test Case ทั้งหมดถูกออกแบบตามหลักวิชาชีพ และนำไปใช้กับระบบ Register/Login จริงได้ทันที
